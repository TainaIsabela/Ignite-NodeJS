...
<h3 align="center">
  Desafio 04: Testes Unitários e de Integração
</h3>
...
```
-  isso fará com que os testes sejam realizados um de cada vez. Pois se todos executarem ao mesmo tempo, os testes de integração vao ter problemas de concorrência.
